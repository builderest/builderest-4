        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (empty($errors)) {
                ...
                $body = '<h2>New quote request</h2>' .
                    ...
                    '<p><strong>Service:</strong> ' . htmlspecialchars($serviceSlug ?: 'Not specified') . '</p>' .
                    '<p><strong>Details:</strong><br>' . nl2br(htmlspecialchars($message)) . '</p>';

                Mailer::send('info@builderest.com', 'New quote request', $body);
                $success = true;
            }
        }

        $this->view('quote/index', compact('errors', 'success', 'serviceSlug'));
    }
}
